...
export const SizeForm: React.FC<SizeFormProps> = ({ initialData }) => {
  ...
  const title = initialData ? "Modifie" : "Ajouter";

  const description = initialData
    ? "Modifier la Taille"
    : "Ajouter une nouvelle Taille";

  const toastMessage = initialData ? "Taille modifiée!" : "Taille ajoutée!";

  const action = initialData ? "Enregister" : "Créer";
